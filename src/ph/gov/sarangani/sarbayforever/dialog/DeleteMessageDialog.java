...
public class DeleteMessageDialog extends Dialog implements View.OnClickListener {
	...
	public DeleteMessageDialog(Activity activity, String messageId,
			int oldDeleteType) {
	...
	void callApi(int deleteType) {
		CouchDB.deleteMessageAsync(messageId, String.valueOf(deleteType),
				new DeleteResultListener(), context, true);
	}
